...
from app.routes import employee_routes, auth_routes , company_routes, audit_log_routes, user_invitation_routes, reactivation_request_routes, reinstatement_request_routes, holiday_routes, login_device_routes, skills_certifications_routes
...
app.include_router(skills_certifications_routes.router, prefix="/api/v1", tags=["Skills & Certifications"])
